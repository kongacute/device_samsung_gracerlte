...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_gracerlte_xx
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board SRPPD15A000RU
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0xD51FFB000 # 0xD52000000 - 20480 (footer)
...
TARGET_INIT_VENDOR_LIB := libinit_gracelte
TARGET_RECOVERY_DEVICE_MODULES := libinit_gracelte
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_gracerlte.cpp
